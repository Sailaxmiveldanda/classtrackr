...
const Upload = ({route, navigation}) => {
  ...
  const manipulateData = async data => {
    ...
    if (allColumnsPresent) {
      ...
      const dirPath = RNFS.DownloadDirectoryPath + '/classTrackrExports';
    ...
    <SafeAreaView
      ...
      <View>
        ...
        <View
          ...
          /> */}
          <Text style={styles.headingText}>ClassTrackr</Text>
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              onPress={() => uploadCSV()}
              disabled={loading}>
              <Text style={styles.buttonText}>Upload to database</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
